 ...
 * 
 * public static <T> void insert(TreeNode<T> root, T value, Comparator<T> comparator) {...}
 * 
 */
public class BstInsert {
    ...
    private static <T> TreeNode<T> doInsert(TreeNode<T> root, T value, Comparator<T> comparator) {
        if (root == null) {
