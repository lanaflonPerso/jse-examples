...
public class KnightsTour {
    public static void printKnightsTour(int boardLength) {
        if (boardLength <= 0) {
            throw new IllegalArgumentException(
                    String.format("Board lengths should be > 0. You passed: %d", boardLength));
        }
    ...
    private static void printKnightsTour(int boardLength, int x, int y, boolean[][] visited) {
    ...
    private static List<Pair<Integer, Integer>> getKnightMoves(int boardLength, int row, int col) {
