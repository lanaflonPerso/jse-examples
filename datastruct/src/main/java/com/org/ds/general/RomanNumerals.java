...
public class RomanNumerals {
    public static long romanToDecimal(String romanNumber) {
        if (romanNumber == null || romanNumber.isEmpty()) {
            throw new IllegalArgumentException("Null or empty roman number passed.");
        }
    ...
    public static String decimalToRoman(int number) {
        if (number < 0) {
            throw new IllegalArgumentException(String.format("Number should be >= 0. You passed: %d", number));
        }
