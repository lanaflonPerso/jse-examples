...
/**
 * Find a subset of elements that are selected from a given set whose sum adds up to a given number K. Assume that the
 * set contains non-negative, unique values.
 */
