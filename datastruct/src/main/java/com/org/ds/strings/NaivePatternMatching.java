...
/**
 * Given a text and a pattern, print all starting indices in the text from where the pattern matches the text.
 * 
...
public class NaivePatternMatching {
    public static void printMatchStartIndicesForPatternWithNoRepeatingCharacters(String text, String pattern) {
