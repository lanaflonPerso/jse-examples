...
import com.org.ds.binarytrees.BstClosestNode;
import com.org.ds.binarytrees.TreeNode;
...
public class BstClosestNodeTest {
    ...
    public void treeWithNoInorderPredecessorAndSubtreeInorderSuccessor() {
        ...
        TreeNode<Integer> answer = BstClosestNode.findClosestNode(root, rootLeft);
