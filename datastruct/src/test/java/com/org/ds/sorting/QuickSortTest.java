...
public class QuickSortTest {
    ...
    public void onlyPivotsInArray() {
        ...
        int pivotIndex = QuickSort.partition(array, 0, array.length - 1, ascOrderComparator, 3);
        assertEquals(4, pivotIndex);
        assertArrayEquals("Failure => Array returned is not partitioned according to the pivot.", array,
