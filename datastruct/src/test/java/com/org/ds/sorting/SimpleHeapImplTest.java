...
public class SimpleHeapImplTest {
    ...
    public void sizeAfterInitialization() {
        ...
        assertEquals(6, new SimpleHeapImpl<Integer>(listWithElements, minHeapComparator).size());
    }

    @Test
    public void sizeAfterAdd() {
        Heap<Integer> heap = new SimpleHeapImpl<Integer>(listWithElements, minHeapComparator);
        heap.add(6);
