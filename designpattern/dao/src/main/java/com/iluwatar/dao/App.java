...
/**
 * 
 * With the DAO pattern, we can use various method calls to retrieve/add/delete/update data without directly interacting
 * with the data. The below example demonstrates basic operations(CRUD): select, add, update, and delete.
 */
public class App {
