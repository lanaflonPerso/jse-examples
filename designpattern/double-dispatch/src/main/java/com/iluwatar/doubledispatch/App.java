 ...
 * 
 * In this example we have hierarchy of objects (GameObject) that can collide to each other. Each object has its own
 * coordinates which are checked against the other objects' coordinates. If there is an overlap, then the objects
