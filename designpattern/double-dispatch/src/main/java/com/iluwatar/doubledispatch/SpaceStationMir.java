...
public class SpaceStationMir extends GameObject {
    ...
    public void collisionResolve(FlamingAsteroid asteroid) {
        System.out.println(String.format("%s hits %s. %s is damaged! %s is set on fire!",
                asteroid.getClass().getSimpleName(), this.getClass().getSimpleName(), this.getClass().getSimpleName(),
    ...
    public void collisionResolve(Meteoroid meteoroid) {
        System.out.println(String.format("%s hits %s. %s is damaged!", meteoroid.getClass().getSimpleName(),
