...
/**
 * 
 * The Event Aggregator pattern channels events from multiple objects into a single object to simplify registration for
 * clients.
 * 
 * In the example LordBaelish, LordVarys and Scout deliver events to KingsHand. KingsHand, the event aggregator, then
 * delivers the events to KingJoffrey.
 *
 */
public class App {
