...
/**
 * 
 * Interpreter pattern breaks sentences into expressions (Expression) that can be evaluated and as a whole form the
 * result.
 * 
 */
public class App {
    ...
    /**
     * 
     * Expressions can be evaluated using prefix, infix or postfix notations This sample uses postfix, where operator
