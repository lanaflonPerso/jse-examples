...
/**
 * This test case is responsible for testing our application by taking advantage of the Model-View-Controller
...
public class FileSelectorPresenterTest {
    ...
    /**
     * Tests if we receive a confirmation when we attempt to open a file that it's name is null or an empty string.
     */
    @Test
