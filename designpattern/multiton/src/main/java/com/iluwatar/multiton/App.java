...
/**
 * 
 * Whereas Singleton design pattern introduces single globally accessible object the Multiton pattern defines many
 * globally accessible objects. The client asks for the correct instance from the Multiton by passing an enumeration as
 * parameter.
 * 
 * In this example Nazgul is the Multiton and we can ask single Nazgul from it using NazgulName. The Nazguls are
