...
/**
 * For JNDI lookup of services from the web.xml. Will match name of the service name that is being requested and return
...
public class InitContext {
    ...
    /**
     * Perform the lookup based on the service name. The returned object will need to be casted into a {@link Service}
     *
     * @param serviceName
     *            a string
