...
/**
 * The service cache implementation which will cache services that are being created. On first hit, the cache will be
 * empty and thus any service that is being requested, will be created fresh and then placed into the cache map. On next
 * hit, if same service name will be requested, it will be returned from the cache
 *
 * @author saifasif
 */
